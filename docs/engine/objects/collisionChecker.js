...
//Distance Function because p5.collide uses it
...
console.log("### p5.collide v0.7.3 ###"), p5.prototype._collideDebug = !1, p5.prototype.collideDebug = function (t) { var _collideDebug = t; }, p5.prototype.collideRectRect = function (t, o, e, i, r, l, n, c) { return t + e >= r && t <= r + n && o + i >= l && o <= l + c; }, p5.prototype.collideRectRectVector = function (t, o, e, i) { return p5.prototype.collideRectRect(t.x, t.y, o.x, o.y, e.x, e.y, i.x, i.y); }, p5.prototype.collideRectCircle = function (t, o, e, i, r, l, n) { var c = r, p = l; return r < t ? c = t : r > t + e && (c = t + e), l < o ? p = o : l > o + i && (p = o + i), this.dist(r, l, c, p) <= n / 2; }, p5.prototype.collideRectCircleVector = function (t, o, e, i) { return p5.prototype.collideRectCircle(t.x, t.y, o.x, o.y, e.x, e.y, i); }, p5.prototype.collideCircleCircle = function (t, o, e, i, r, l) { return this.dist(t, o, i, r) <= e / 2 + l / 2; }, p5.prototype.collideCircleCircleVector = function (t, o, e, i) { return p5.prototype.collideCircleCircle(t.x, t.y, o, e.x, e.y, i); }, p5.prototype.collidePointCircle = function (t, o, e, i, r) { return this.dist(t, o, e, i) <= r / 2; }, p5.prototype.collidePointCircleVector = function (t, o, e) { return p5.prototype.collidePointCircle(t.x, t.y, o.x, o.y, e); }, p5.prototype.collidePointEllipse = function (t, o, e, i, r, l) { var n = r / 2, c = l / 2; if (t > e + n || t < e - n || o > i + c || o < i - c)
    ...
    if (!0 === l)
        if (this.collidePointPoly(t, o, r))
            return !0;
} return !1; }, p5.prototype.collideRectPolyVector = function (t, o, e, i) { return p5.prototype.collideRectPoly(t.x, t.y, o.x, o.y, e, i); }, p5.prototype.collideLinePoly = function (t, o, e, i, r) { for (var l = 0, n = 0; n < r.length; n++) {
    (l = n + 1) === r.length && (l = 0);
    var c = r[n].x, p = r[n].y, y = r[l].x, d = r[l].y;
    if (this.collideLineLine(t, o, e, i, c, p, y, d))
        return !0;
} return !1; }, p5.prototype.collideLinePolyVector = function (t, o, e) { return p5.prototype.collideLinePoly(t.x, t.y, o.x, o.y, e); }, p5.prototype.collidePolyPoly = function (t, o, e) { void 0 === e && (e = !1); for (var i = 0, r = 0; r < t.length; r++) {
    (i = r + 1) === t.length && (i = 0);
