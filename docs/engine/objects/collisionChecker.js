...
class SpatialHashMap {
  ...
  getNearby(uuid) {
    ...
    for (let i of allPossible) {
      ...
      for (let i2 in values) {
        if (allColliders[values[i2]])
          uuidList[values[i2]] = true;
      }
    }
  ...
  setOrAdd(ind, value) {
    ...
    if (!this.grid.has(ind))
      return this.grid.set(ind, [value]);
        ...
        if (JSON.stringify(newValues) === JSON.stringify(oldValues)) {
          ...
          for (let uuid in oldColliders) {
            if (allColliders.hasOwnProperty(uuid)) {
              ...
              if (cache[uuid]) {
                for (let uuid22 in cache[uuid]) {
                  delete cache[uuid22][uuid];
                }
                delete cache[uuid];
              }
            }
...
function testCollision(type1, type2, values1, values2, isVector) {
  ...
  if (typeof test === "function") {
    ...
    let test2 = handler.prototype["collide" + type2 + type1 + (isVector ? "Vector" : "")];
    if (typeof test2 === "function") {
      return test2(...values2[1], ...values1[1]);
    } else {
...
console.log("### handler.collide v0.7.3 ###"), handler.prototype._collideDebug = false, handler.prototype.collideDebug = function(t) {
  var _collideDebug = t;
}, handler.prototype.collideRectRect = function(t, o, e, i, r, l, n, c) {
  return t + e >= r && t <= r + n && o + i >= l && o <= l + c;
}, handler.prototype.collideRectRectVector = function(t, o, e, i) {
  return handler.prototype.collideRectRect(t.x, t.y, o.x, o.y, e.x, e.y, i.x, i.y);
}, handler.prototype.collideRectCircle = function(t, o, e, i, r, l, n) {
  var c = r, p = l;
  return r < t ? c = t : r > t + e && (c = t + e), l < o ? p = o : l > o + i && (p = o + i), this.dist(r, l, c, p) <= n / 2;
}, handler.prototype.collideRectCircleVector = function(t, o, e, i) {
  return handler.prototype.collideRectCircle(t.x, t.y, o.x, o.y, e.x, e.y, i);
}, handler.prototype.collideCircleCircle = function(t, o, e, i, r, l) {
  return this.dist(t, o, i, r) <= e / 2 + l / 2;
}, handler.prototype.collideCircleCircleVector = function(t, o, e, i) {
  return handler.prototype.collideCircleCircle(t.x, t.y, o, e.x, e.y, i);
}, handler.prototype.collidePointCircle = function(t, o, e, i, r) {
  return this.dist(t, o, e, i) <= r / 2;
}, handler.prototype.collidePointCircleVector = function(t, o, e) {
  return handler.prototype.collidePointCircle(t.x, t.y, o.x, o.y, e);
}, handler.prototype.collidePointEllipse = function(t, o, e, i, r, l) {
  var n = r / 2, c = l / 2;
  if (t > e + n || t < e - n || o > i + c || o < i - c)
    return false;
  var p = t - e, y = o - i, d = c * this.sqrt(this.abs(n * n - p * p)) / n;
  return y <= d && y >= -d;
}, handler.prototype.collidePointEllipseVector = function(t, o, e) {
  return handler.prototype.collidePointEllipse(t.x, t.y, o.x, o.y, e.x, e.y);
}, handler.prototype.collidePointRect = function(t, o, e, i, r, l) {
  return t >= e && t <= e + r && o >= i && o <= i + l;
}, handler.prototype.collidePointRectVector = function(t, o, e) {
  return handler.prototype.collidePointRect(t.x, t.y, o.x, o.y, e.x, e.y);
}, handler.prototype.collidePointLine = function(t, o, e, i, r, l, n) {
  var c = this.dist(t, o, e, i), p = this.dist(t, o, r, l), y = this.dist(e, i, r, l);
  return void 0 === n && (n = 0.1), c + p >= y - n && c + p <= y + n;
}, handler.prototype.collidePointLineVector = function(t, o, e, i) {
  return handler.prototype.collidePointLine(t.x, t.y, o.x, o.y, e.x, e.y, i);
}, handler.prototype.collideLineCircle = function(t, o, e, i, r, l, n) {
...
}, handler.prototype.collideLineCircleVector = function(t, o, e, i) {
  return handler.prototype.collideLineCircle(t.x, t.y, o.x, o.y, e.x, e.y, i);
}, handler.prototype.collideLineLine = function(t, o, e, i, r, l, n, c, p) {
...
}, handler.prototype.collideLineLineVector = function(t, o, e, i, r) {
  return handler.prototype.collideLineLine(t.x, t.y, o.x, o.y, e.x, e.y, i.x, i.y, r);
}, handler.prototype.collideLineRect = function(t, o, e, i, r, l, n, c, p) {
  var y, d, u, s, x;
...
}, handler.prototype.collideLineRectVector = function(t, o, e, i, r) {
  return handler.prototype.collideLineRect(t.x, t.y, o.x, o.y, e.x, e.y, i.x, i.y, r);
}, handler.prototype.collidePointPoly = function(t, o, e) {
  ...
  return i;
}, handler.prototype.collidePointPolyVector = function(t, o) {
  return handler.prototype.collidePointPoly(t.x, t.y, o);
}, handler.prototype.collideCirclePoly = function(t, o, e, i, r) {
  void 0 === r && (r = false);
  ...
  if (true === r && this.collidePointPoly(t, o, i))
    return true;
  return false;
}, handler.prototype.collideCirclePolyVector = function(t, o, e, i) {
  return handler.prototype.collideCirclePoly(t.x, t.y, o, e, i);
}, handler.prototype.collideRectPoly = function(t, o, e, i, r, l) {
  null == l && (l = false);
  ...
  return false;
}, handler.prototype.collideRectPolyVector = function(t, o, e, i) {
  return handler.prototype.collideRectPoly(t.x, t.y, o.x, o.y, e, i);
}, handler.prototype.collideLinePoly = function(t, o, e, i, r) {
  ...
  return false;
}, handler.prototype.collideLinePolyVector = function(t, o, e) {
  return handler.prototype.collideLinePoly(t.x, t.y, o.x, o.y, e);
}, handler.prototype.collidePolyPoly = function(t, o, e) {
  void 0 === e && (e = false);
  ...
  return false;
}, handler.prototype.collidePolyPolyVector = function(t, o, e) {
  return handler.prototype.collidePolyPoly(t, o, e);
}, handler.prototype.collidePointTriangle = function(t, o, e, i, r, l, n, c) {
  var p = this.abs((r - e) * (c - i) - (n - e) * (l - i));
  return this.abs((e - t) * (l - o) - (r - t) * (i - o)) + this.abs((r - t) * (c - o) - (n - t) * (l - o)) + this.abs((n - t) * (i - o) - (e - t) * (c - o)) === p;
}, handler.prototype.collidePointTriangleVector = function(t, o, e, i) {
  return handler.prototype.collidePointTriangle(t.x, t.y, o.x, o.y, e.x, e.y, i.x, i.y);
}, handler.prototype.collidePointPoint = function(t, o, e, i, r) {
  return void 0 === r && (r = 0), this.dist(t, o, e, i) <= r;
}, handler.prototype.collidePointPointVector = function(t, o, e) {
  return handler.prototype.collidePointPoint(t.x, t.y, o.x, o.y, e);
}, handler.prototype.collidePointArc = function(t, o, e, i, r, l, n, c) {
  void 0 === c && (c = 0);
  ...
  return false;
}, handler.prototype.collidePointArcVector = function(t, o, e, i, r, l) {
  return handler.prototype.collidePointArc(t.x, t.y, o.x, o.y, e, i, r, l);
};
