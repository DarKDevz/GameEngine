...
p5.prototype.collideFrustumRectVector = function (a, b, c) {
    ...
    return checkIfVisible(createVector(startPoint.x,startPoint.y,0)) || checkIfVisible(createVector(endPoint.x,endPoint.y,0));
}
p5.prototype.collideFrustumCircleVector = function (a, b, c) {
    ...
    return checkIfVisible(createVector(b.x,b.y,0),c);
}