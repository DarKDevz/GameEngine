    ...
    moveObjects(frameDiff) {
        for (let uuid of selectedObjects) {
            ...
            if (tempBox) {
                ...
                let remainder = {
                    x: diff.x % this.gridSize,
                    y: diff.y % this.gridSize
                };
                this.tryOffset[uuid] = remainder;
                let newDiff = {
                    x: diff.x - remainder.x,
                    y: diff.y - remainder.y
                };
                newPos.x += newDiff.x;
                newPos.y += newDiff.y;
    ...
    pasteObjects() {
        ...
        for (let copiedObj of this.copiedObjs) {
            ...
            for (let component of copiedObj.components) {
                ...
                _obj.components.push(new componentClass({
                    ...component.params,
                    obj: _obj
                }));
            }
